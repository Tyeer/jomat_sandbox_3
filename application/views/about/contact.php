...
<html class="ie9 no-js" lang="en-US">
	...
	<html class="not-ie no-js" lang="en-US">
		...
		<head>
			...
			<link rel="alternate" type="application/rss+xml" title="CarDealer &raquo; Contacts Comments Feed" href="feed/index.html" />
			...
			<link rel="alternate" type="application/json+oembed" href="../wp-json/oembed/1.0/embed857b.json?url=http%3A%2F%2Fcardealer.webtemplatemasters.com%2Fcontacts%2F" />
			<link rel="alternate" type="text/xml+oembed" href="../wp-json/oembed/1.0/embedf88d?url=http%3A%2F%2Fcardealer.webtemplatemasters.com%2Fcontacts%2F&amp;format=xml" />
			<noscript>
				<style>.woocommerce-product-gallery{ opacity: 1 !important; }</style>
			</noscript>
			<style type="text/css">.recentcomments a{display:inline !important;padding:0 !important;margin:0 !important;}</style>
		</head>
		<body class="page-template-default page page-id-16 woocommerce-no-js alternate-layout">
			<!-- Mobile Nav toggle -->
					...
					<div id="content" class="no_sidebar">
						...
						<section id="section_515337354420" class="padding-top-40 padding-bottom-40">
							<div class="container">
								<div  class="row">
									<div class="col-md-4">
										<h3 class="section-title" style="margin-bottom: inheritpx; ">Our Contacts</h3>
										</p>
										<p>
			...
			<script type='text/javascript' src='https://maps.google.com/maps/api/js?key=AIzaSyByr7q4xavGXbdnvlII42we-lBNEOkSQaQ&amp;ver=4.9.7'></script>
			<input type="hidden" id="post_id" value="16">
		</body>
		<!-- Mirrored from cardealer.webtemplatemasters.com/contacts/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 08 Jul 2018 16:59:22 GMT -->
	</html>
